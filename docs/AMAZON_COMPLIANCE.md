...
**Última revisão manual deste documento:** 2026-08-31 (`AMAZON_POLICY_REVIEW_DATE` no `.env`).
O `/admin` mostra um aviso quando essa data está a mais de 90 dias no passado. Atualize a
variável de ambiente _e_ esta data sempre que revisar as políticas oficiais.
