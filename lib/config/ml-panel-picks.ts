...
const rows: Row[] = [
  ...
  // Construção (owner's choice, 2026-09-26): fresh read of the panel's 'Mais vendidos' tab (260 products, the whole
  // category, none suspect). New ones paying >= R$ 10 per sale; the 20 biggest commissions are featured at the top.
  [
  ...
  ["Forro De Pvc Plus 6m² - Imbuia Ei", 12, 0, 282.24, 5000, 4.8, "construcao"],
  [
  ...
  ["Mdf Branco Cortado Sob Medida 15mm", 12, 0, 190, 100, 5, "construcao"],
  [
